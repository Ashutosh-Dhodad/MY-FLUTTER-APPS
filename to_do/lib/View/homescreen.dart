...
import "package:to_do/controller/database.dart";
                          ...
                          itemBuilder: (context, index) {
                            return Slidable(
                              ...
                              child: Container(
                                ...
                                width: 400,
                                decoration: const BoxDecoration(
                                  color: Color.fromARGB(255, 225, 156, 217),
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:Color.fromARGB(255, 215, 19, 160),
                                        borderRadius:
                                    ...
                                    Checkbox(
                                      value:
                                          (taskCardList[index].isfinished == 0) ? false : true,
                                           activeColor:
